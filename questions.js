...
const QUESTIONS = {
  "g1": [ // 초1-2, 16문항
    ...
    { id: "q12", layer: "L3", text: "외국 사람이 나한테 영어로 말을 걸면...", b: { text: "신나! 대답해보고 싶어", dim: "confidence" }, a: { text: "당황스러워서 입이 잘 안 떨어져", dim: "confidence_low" } },
    ...
    { id: "q14", layer: "L3", text: "영어 단어 시험에서 점수가 안 좋으면...", b: { text: "바로 다시 외워볼 거야", dim: "resilience" }, a: { text: "속상해서 한동안 영어 보기가 싫어져", dim: "resilience_low" } },
    ...
    { id: "q16", layer: "L3", text: "영어로 친구들 앞에서 발표하는 거랑, 선생님이랑 1:1로 이야기하는 거 중에...", b: { text: "친구들 앞에서 발표하는 게 더 좋아", dim: "stage" }, a: { text: "선생님이랑 둘이 이야기하는 게 더 좋아", dim: "stage_low" } }
  ],
  ...
  "g2": [ // 초3-4, 24문항
    ...
    { id: "q8", layer: "L1", text: "원어민 선생님이 빠르게 말할 때...", b: { text: "전부 못 알아들어도 중요한 단어는 귀에 들어와", dim: "sound" }, a: { text: "천천히 말해주면 더 잘 이해할 수 있어", dim: "sound_low" } },
    ...
    { id: "q16", layer: "L2", text: "내가 쓴 영어 글에서 빨간 펜 교정이 많으면...", b: { text: "다음에 안 틀리도록 꼼꼼히 봐야지", dim: "form" }, a: { text: "일단 의미가 통했으니까 괜찮아, 다음에 자연스럽게 나아지겠지", dim: "form_low" } },
    { id: "q17", layer: "L3", text: "\"너 영어 잘한다!\"라는 말을 들으면...", a: { text: "맞아, 나 영어 자신 있어", dim: "confidence" }, b: { text: "아니야, 나 잘 못하는데...", dim: "confidence_low" } },
    { id: "q18", layer: "L3", text: "처음 만난 외국인 앞에서 영어로 자기소개를 하라고 하면...", b: { text: "긴장은 되지만 바로 해볼 수 있어", dim: "confidence" }, a: { text: "머릿속이 하얘져서 한마디도 못 할 것 같아", dim: "confidence_low" } },
    ...
    { id: "q20", layer: "L3", text: "영어 시험에서 기대보다 점수가 낮으면...", b: { text: "뭘 틀렸는지 바로 확인하고 다음을 준비해", dim: "resilience" }, a: { text: "속상한 마음이 며칠은 가는 것 같아", dim: "resilience_low" } },
    ...
    { id: "q22", layer: "L3", text: "영어 수업에서 가장 재미있는 순간은?", b: { text: "원어민 선생님이랑 진짜 대화가 될 때", dim: "connection" }, a: { text: "어려운 문제를 맞혔을 때", dim: "connection_low" } },
    { id: "q23", layer: "L3", text: "영어 발표 수업이 있는 날은...", a: { text: "기대돼! 준비한 걸 보여줄 수 있으니까", dim: "stage" }, b: { text: "발표보다는 조별 활동이나 짝 활동이 더 좋아", dim: "stage_low" } },
    { id: "q24", layer: "L3", text: "영어 연극이나 역할극을 하라고 하면...", b: { text: "역할을 맡아서 앞에서 해보고 싶어", dim: "stage" }, a: { text: "대본을 쓰거나 소품을 준비하는 역할이 더 잘 맞아", dim: "stage_low" } }
  ],
  ...
  "g3": [ // 초5-6, 30문항
    ...
    { id: "q8", layer: "L1", text: "영어 책을 읽을 때...", b: { text: "모르는 단어가 있어도 문맥으로 짐작하며 계속 읽어 나가", dim: "text" }, a: { text: "모르는 단어를 확인하고 넘어가는 게 더 마음이 편해", dim: "text_low" } },
    { id: "q9", layer: "L1", text: "처음 보는 영어 단어인데 상황을 보고 뜻을 맞힌 경험이...", b: { text: "자주 있어, 맥락을 보면 대충 감이 와", dim: "scene" }, a: { text: "가끔 있지만, 확실한 뜻을 아는 게 더 중요해", dim: "scene_low" } },
    ...
    { id: "q18", layer: "L2", text: "영어 수업에서 \"자유 주제로 써보세요\"라고 하면...", b: { text: "배운 것 넘어서 새로운 시도를 해보고 싶어", dim: "frontier" }, a: { text: "뭘 써야 할지 막막해, 주제를 정해줬으면 좋겠어", dim: "frontier_low" } },
    { id: "q19", layer: "L2", text: "말하기 수업에서 나의 영어 발화량은...", b: { text: "틀리든 말든 많이 말하는 편이야", dim: "flow" }, a: { text: "필요할 때만 말하는 편이야", dim: "flow_low" } },
    ...
    { id: "q22", layer: "L3", text: "원어민 선생님이 빠르게 말할 때...", b: { text: "못 알아들으면 \"다시 말해주세요\" 하고 바로 물어봐", dim: "confidence" }, a: { text: "못 알아들은 게 들킬까봐 그냥 넘어가", dim: "confidence_low" } },
    ...
    { id: "q25", layer: "L3", text: "영어 발표에서 실수를 한 경험이 있다면...", b: { text: "다음엔 더 잘 준비하자는 동기가 돼", dim: "resilience" }, a: { text: "그 기억이 한동안 신경 쓰여", dim: "resilience_low" } },
    { id: "q26", layer: "L3", text: "나한테 영어란?", a: { text: "세상 사람들과 소통하는 도구", dim: "connection" }, b: { text: "내 목표를 이루기 위한 중요한 능력", dim: "connection_low" } },
    { id: "q27", layer: "L3", text: "영어를 쓸 때 가장 뿌듯한 순간은?", b: { text: "외국인이랑 진짜 대화가 통했을 때", dim: "connection" }, a: { text: "어려운 영어 과제를 완성했을 때", dim: "connection_low" } },
    ...
    { id: "q30", layer: "L3", text: "영어 토론이나 디베이트를 하라고 하면...", b: { text: "내 의견을 영어로 표현해보는 도전이 재밌을 것 같아", dim: "stage" }, a: { text: "글로 써서 내 의견을 정리하는 게 더 잘 맞아", dim: "stage_low" } }
  ]
};
